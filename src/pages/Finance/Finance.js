      ...
      <div class='container mx-auto pb-2 px-4'>
        <section class='min-h-screen flex items-center justify-center py-4'>
          <div class='w-full max-w-5xl'>
            ...
            {/* form */}
            <form class='w-full'>
              <div class='grid grid-cols-1 gap-4 lg:grid-cols-2 border rounded-lg'>
                {/* <!-- First Section --> */}
                <div class='col-span-1  rounded-lg p-4'>
                  <div className='m-4'>
                    <div class='mb-4'>
                      <label
                ...
                {/* <!-- Second Section --> */}
                <div class='col-span-1 border-l r p-4'>
                  <div className='m-4'>
                    <div class='mb-4'>
                      <label
                        class='block font-medium mb-2 text-[#9E2A31]'
