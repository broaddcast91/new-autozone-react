    ...
    <>
      ...
      >
        <img
          ...
          src={require('../../assets/banners/01_Bada-Dost-i4-with-LNT_Banner-Desktop-1440x620px.jpg')}
          alt='dost-banner'
        />
      ...
      <div className='container mx-auto py-10 mt-10'>
        <div className='flex justify-between items-center p-4'>
          <div className='text-left'>
            <p className='text-4xl font-bold'>Bada Dost i4 LNT</p>
          </div>
    ...
    <div className='container mx-auto'>
      <Tab.Group>
        <Tab.List className='flex flex-row space-x-1 border-b-2 border-gray-300'>
          {['Bada Dost i4 LNT', 'SPECIFICATIONS'].map((tab) => (
            <Tab
              key={tab}
              className={({ selected }) =>
                classNames(
          ...
          <div className='dropdown dropdown-bottom'>
            ...
            >
              <li className='text-3xl rounded-md hover:bg-red-200 text-[#9E2A31]'>
                <a>
                  Bada Dost i4 LNT| <span className='text-xs ml-4'>Price</span> ₹
                  9.00 L
                </a>
              </li>
              <li>
